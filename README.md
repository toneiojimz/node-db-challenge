...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  relational databases store data in their tables and SQL is a language to manage data in databases.

- [ ] Why do tables need a `primary key`?

   a primary key is needed to identify and access information in a table. a primary key points to a specific value.
